...
public final class RedisDependencyAutoConfiguration {
    ...
    static final class RedisMessageListenerRegistrar {
        ...
        RedisMessageListenerRegistrar(RedisMessageListenerContainer redisMessageListenerContainer, ObjectProvider<MessageListener> messageListeners, GenericJacksonJsonRedisSerializer genericJacksonJsonRedisSerializer){
