...
public final class ClusterDcWebSocketAutoConfiguration {
    ...
    static final class ClusterWebSocketHandlerRegistrar {
        ClusterWebSocketHandlerRegistrar(ObjectProvider<ClusterDcWebSocketHandler> clusterDcWebSocketHandler, RedisMessageListenerContainer redisMessageListenerContainer, GenericJackson2JsonRedisSerializer redisSerializer) {
